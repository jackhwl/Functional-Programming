...
// modify/move this function
function getStudentsByID(curStudent) { 
    var original_students = curStudent.slice()
    students = curStudent.slice()
    var sorted_students = sortStudentsByID()
    students = original_students.slice()
